...
const Home = () => {
  return (
    <main className='h-full w-full'>
      <section className='relative flex h-screen w-full flex-col items-center justify-center bg-[#418d76] bg-[url("/images/background.png")] bg-cover bg-center bg-no-repeat px-6 pt-8 shadow-xl dark:bg-[#205848] dark:bg-none lg:px-8'>
