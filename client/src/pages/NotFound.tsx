...
const Home = () => {
  return (
    <main className='h-full max-h-screen w-full overflow-clip bg-[#418d76] bg-[url("/images/background.png")] bg-cover bg-center bg-no-repeat dark:bg-[#205848] dark:bg-none'>
